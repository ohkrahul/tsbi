...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Full case study pages \u2014 client projects with concept, frames, and metrics';
  ...
  attributes: {
    ...
    conceptBody: Schema.Attribute.Text;
    conceptGrad: Schema.Attribute.String;
    conceptImage: Schema.Attribute.Media<'images'>;
    conceptTitle: Schema.Attribute.String;
    coverImage: Schema.Attribute.Media<'images'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deliverables: Schema.Attribute.String;
    frames: Schema.Attribute.JSON;
    gradFrom: Schema.Attribute.String;
    gradTo: Schema.Attribute.String;
    heroGrad: Schema.Attribute.String;
    heroImage: Schema.Attribute.Media<'images'>;
    isSpan2: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiClientBrandClientBrand extends Struct.CollectionTypeSchema {
  collectionName: 'client_brands';
  info: {
    description: 'Brand entries for the home page client wheel and the Clients page';
    displayName: 'Client Brand';
    pluralName: 'client-brands';
    singularName: 'client-brand';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    accent: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#e0197d'>;
    ...
    isEntertainment: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiJobListingJobListing extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    location: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Full-time \u00B7 Mumbai'>;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<99>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiJournalArticleJournalArticle
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['Thought Leadership', 'Insights', 'Behind the Idea', 'Culture', 'Trends']
    > &
      Schema.Attribute.Required;
...
export interface ApiLeadershipSlideLeadershipSlide
  extends Struct.CollectionTypeSchema {
  collectionName: 'leadership_slides';
  info: {
    description: 'CEO, COO and Reel slides for the About page Leadership section';
    displayName: 'Leadership Slide';
    pluralName: 'leadership-slides';
    singularName: 'leadership-slide';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['leader', 'reel']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site settings \u2014 stats, metadata, footer text';
  ...
  attributes: {
    aboutStats: Schema.Attribute.JSON &
      Schema.Attribute.DefaultTo<
        [
          {
            label: 'Talents Managed';
            pink: true;
            val: '150+';
          },
          {
    ...
    footerTagline: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'The Small Big Idea.'>;
    ...
    metaTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'TSBI \u2013 The Small Big Idea'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    workMetrics: Schema.Attribute.JSON &
      Schema.Attribute.DefaultTo<
        [
          {
...
export interface ApiWorkItemWorkItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Cards shown on the Work/Portfolio grid';
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['Campaigns', 'Films', 'Social', 'Websites', 'Tech']
    > &
      Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::client-brand.client-brand': ApiClientBrandClientBrand;
      'api::job-listing.job-listing': ApiJobListingJobListing;
      'api::journal-article.journal-article': ApiJournalArticleJournalArticle;
      'api::leadership-slide.leadership-slide': ApiLeadershipSlideLeadershipSlide;
